        ...
        while True:
            ...
            if data:
                ...
                if address not in self.address_to_client_id_dict:
                    max_client_id = max(self.client_id_to_address_dict)
                ...
                send_data = Package.ecode(p_type=PackegeType.DATA, n_client_id=n_client_id, b_data=data.get('raw'))
    ...
    async def handle_transport(self):
        while True:
            ...
            for n_client_id, client in self.client_id_to_client.items():
                ...
                if data:
                    b_data = Package.ecode(p_type=PackegeType.DATA, n_client_id=n_client_id, b_data=data)
